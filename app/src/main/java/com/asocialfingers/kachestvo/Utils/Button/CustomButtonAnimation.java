...
public class CustomButtonAnimation {
    ...
    public static class Params {
        ...
        private CustomAnimatedButton button;
        private Listener animationListener;

        private Params(@NonNull CustomAnimatedButton button) {
            this.button = button;
        }

        public static Params create(@NonNull CustomAnimatedButton button) {
    ...
    public void start() {
        ...
        ObjectAnimator strokeWidthAnimation = ObjectAnimator.ofInt(background, "strokeWidth", mParams.fromStrokeWidth, mParams.toStrokeWidth);
